...
Interpolator::Interpolator(double first, double last, double step, std::string filename) :
    Interpolator(first, last, step,  ConvertToString(filename), '\n', '\t') {
}
...
vector<Coord> SplitIntoData(const string& raw_text, char delimLines, char delimData) {
